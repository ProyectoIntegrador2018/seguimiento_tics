...
import {
  ...
  formStyle,
  formBttn
} from "../../../assets/jss/components/usersStyle";
      ...
      <div>
        ...
        <div style={tableContainer}>
          ...
          {this.state.users.length == 0 ? (
            <span style={title}>No hay usuarios registrados</span>
          ) : (
            this.renderTable()
          )}

          <Button
            onClick={this.onDisplayFormClick}
            style={roundedBttn}
  ...
  renderTable() {
    return (
      <div style={tableWrapper}>
        <div style={table}>
          <div style={header}>
            <div style={cellHeader}>Correo electrónico</div>
          </div>
